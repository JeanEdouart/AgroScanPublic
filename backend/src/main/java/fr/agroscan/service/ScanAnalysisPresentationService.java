...
public class ScanAnalysisPresentationService {
    ...
    private static final Map<String, DiseasePresentation> DISEASE_PRESENTATIONS = Map.ofEntries(
            disease("Apple__Alternaria_leaf_spot", "Alternariose du pommier",
                    "Retirez les feuilles fortement tachees et evacuez les debris vegetaux autour de l'arbre.",
                    "Taillez pour ameliorer l'aeration du feuillage et limiter l'humidite persistante.",
                    "Surveillez les periodes chaudes et humides, puis appliquez une protection fongicide adaptee si les taches progressent."),
            disease("AppleAlternaria_leafspot", "Alternariose du pommier",
                    "Retirez les feuilles fortement tachees et evacuez les debris vegetaux autour de l'arbre.",
                    "Taillez pour ameliorer l'aeration du feuillage et limiter l'humidite persistante.",
                    "Surveillez les periodes chaudes et humides, puis appliquez une protection fongicide adaptee si les taches progressent."),
            disease("Apple___Apple_scab", "Tavelure du pommier",
            ...
            disease("AppleApple_scab", "Tavelure du pommier",
                    "Ramassez les feuilles tombees et retirez les parties atteintes pour reduire les spores.",
                    "Taillez legerement pour ameliorer l'aeration de l'arbre.",
                    "En prevention, appliquez un traitement adapte au pommier au debut des periodes humides."),
            disease("Apple__Apple_scab", "Tavelure du pommier",
                    ...
                    "Taillez legerement pour ameliorer l'aeration de l'arbre.",
                    "En prevention, appliquez un traitement adapte au pommier au debut des periodes humides."),
            disease("Apple_Black_rot", "Pourriture noire du pommier",
            ...
            disease("Apple___Black_rot", "Pourriture noire du pommier",
                    ...
                    "Evitez les blessures sur les fruits et gardez une bonne hygiene autour de l'arbre.",
                    "Surveillez les nouvelles taches et intervenez rapidement sur les zones contaminees."),
            disease("Apple__Brown_spot", "Tache brune du pommier",
                    "Retirez les feuilles les plus atteintes pour limiter la source de contamination.",
                    "Evitez l'humidite durable dans le feuillage en espacant et en aerant la vegetation.",
                    "Surveillez les nouvelles taches apres pluie et utilisez un traitement fongicide adapte si la maladie s'etend."),
            disease("AppleBrown_spot", "Tache brune du pommier",
                    "Retirez les feuilles les plus atteintes pour limiter la source de contamination.",
                    "Evitez l'humidite durable dans le feuillage en espacant et en aerant la vegetation.",
                    "Surveillez les nouvelles taches apres pluie et utilisez un traitement fongicide adapte si la maladie s'etend."),
            disease("Apple_Cedar_apple_rust", "Rouille grillagee du pommier",
            ...
            disease("Apple___Cedar_apple_rust", "Rouille grillagee du pommier",
                    ...
                    "Eloignez les genievriers proches si la maladie revient chaque saison.",
                    "Favorisez une bonne circulation de l'air et utilisez un traitement preventif adapte en periode a risque."),
            disease("Apple__Frogeye_leaf_spot", "Tache ocellee du pommier",
                    "Supprimez les feuilles, rameaux ou fruits fortement atteints lorsque c'est possible.",
                    "Retirez les chancres et bois morts pendant la taille pour reduire les reservoirs de maladie.",
                    "Maintenez une bonne hygiene du verger et surveillez les attaques apres les episodes humides."),
            disease("AppleFrogeye_leaf_spot", "Tache ocellee du pommier",
                    "Supprimez les feuilles, rameaux ou fruits fortement atteints lorsque c'est possible.",
                    "Retirez les chancres et bois morts pendant la taille pour reduire les reservoirs de maladie.",
                    "Maintenez une bonne hygiene du verger et surveillez les attaques apres les episodes humides."),
            disease("Apple__Gey_spot", "Tache grise du pommier",
                    "Retirez les feuilles tres touchees et gardez le pied de l'arbre propre.",
                    "Favorisez une bonne aeration du feuillage pour accelerer le sechage apres pluie.",
                    "Si les symptomes progressent, demandez conseil pour choisir une protection fongicide compatible avec le pommier."),
            disease("AppleGeyspot", "Tache grise du pommier",
                    "Retirez les feuilles tres touchees et gardez le pied de l'arbre propre.",
                    "Favorisez une bonne aeration du feuillage pour accelerer le sechage apres pluie.",
                    "Si les symptomes progressent, demandez conseil pour choisir une protection fongicide compatible avec le pommier."),
            healthy("Applehealthy", "Pommier sain"),
            healthy("Apple___healthy", "Pommier sain"),
            disease("Apple__Mosaic", "Mosaique du pommier",
                    "Evitez de greffer ou multiplier du bois provenant d'un arbre suspect.",
                    "Desinfectez les outils de taille et surveillez les arbres proches.",
                    "Il n'existe pas de traitement curatif fiable: remplacez les sujets tres affaiblis par du materiel vegetal certifie sain."),
            disease("AppleMosaic", "Mosaique du pommier",
                    "Evitez de greffer ou multiplier du bois provenant d'un arbre suspect.",
                    "Desinfectez les outils de taille et surveillez les arbres proches.",
                    "Il n'existe pas de traitement curatif fiable: remplacez les sujets tres affaiblis par du materiel vegetal certifie sain."),
            disease("Apple__Powdery_mildew", "Oidium du pommier",
                    "Taillez et eliminez les jeunes pousses blanchatres ou deformees.",
                    "Evitez les exces d'azote qui favorisent les pousses tendres sensibles.",
                    "Ameliorez l'aeration de l'arbre et appliquez une protection anti-oidium adaptee si la maladie revient."),
            disease("ApplePowdery_mildew", "Oidium du pommier",
                    "Taillez et eliminez les jeunes pousses blanchatres ou deformees.",
                    "Evitez les exces d'azote qui favorisent les pousses tendres sensibles.",
                    "Ameliorez l'aeration de l'arbre et appliquez une protection anti-oidium adaptee si la maladie revient."),
